...
<head>
  ...
  <meta property="og:url" content="https://3728-2804-7fa8-9081-e600-2347-3f74-6472-a4e7.ngrok-free.app/produtos/${produto.id}.html" />
      ...
      <div class="product-header">
        ...
        <div class="product-details">
          ...
          <button
            ...
            data-item-weight= "${produto.peso}"
            data-item-height="${produto.altura}"
            data-item-width="${produto.largura}"
            data-item-length="${produto.comprimento}"
            data-item-ncm="${produto.ncm}"
            data-item-valor_declarado="${produto.valor_declarado}"
            data-item-custom1-name="Sabor"
            data-item-custom1-options="Chocolate|Baunilha|Morango|Cookies"
          >
